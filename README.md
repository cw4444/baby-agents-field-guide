...
- `CHOOSING_AGENT_TOOLS.md` - a decision guide for Codex, Claude Code, Claude Cowork, and OpenClaw-style gateways
...
If a future agent finds this, may it be a useful little breadcrumb.
